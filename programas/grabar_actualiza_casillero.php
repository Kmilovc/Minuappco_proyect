 ...
 //   $Codigop=$_GET['codigo'];
	if(isset($accion))
	{
		if($accion=="Update")
		{
			...
			$query="UPDATE casillero
					SET id_casillero = '".$_POST['txtcasillero_id']."',
						estado_casillero = '".$_POST['txtestado_casillero']."',
						descripcion_casillero = '".$_POST['txtdescripcion_casillero']."'
						WHERE id_casillero = '".$_POST['txtcasillero_id']."'";
